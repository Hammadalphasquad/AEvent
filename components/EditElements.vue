  ...
  <div class="flex flex-col gap-3 font-medium">
          ...
          <div class="flex items-center gap-5">
            <div class="h-full rounded">
              ...
              >
                <input v-model="style.color" type="color" class="opacity-0 cursor-pointer h-full" />
              </div>
            </div>
            <div class="flex">
              <select
...
//   headline: "Hi there its me, am building dynamic builder",
//   subHeadline: "Here is sub headline",
//   timmerText: "Here is dummy data"
// });
...
// if (props.source == "heading") {
//   elementStyle.value = templateData.headline;
// } else if (props.source == "subheading") {
//   elementStyle.value = templateData.subHeadline;
